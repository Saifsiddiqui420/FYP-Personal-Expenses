          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button
                size="lg"
                variant="outline"
                className="text-lg px-8 bg-transparent border-white text-white hover:bg-white hover:text-purple-600 font-semibold"
                onClick={() => openLogin()}
              >
                Sign In
              </Button>
      ...
      <section className="py-24 px-4 bg-gradient-to-r from-indigo-600 to-purple-700 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Button
            size="lg"
            variant="secondary"
            className="text-lg px-12 font-semibold inline-flex items-center gap-2"
            onClick={() => openSignup()}
          >
            Explore More
